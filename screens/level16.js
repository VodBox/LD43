window.level16 = {
    ...
    load: function() {
        ...
        let bg = new PIXI.Sprite.from("levels/level16BG.png");
        bg.width = w;
        bg.height = h;
        ...
        let fg = new PIXI.Sprite.from("levels/level16FG.png");
        fg.width = w;
        fg.height = h;
        ...
        this.breakable = new PIXI.Sprite.from("levels/level16Break.png");
